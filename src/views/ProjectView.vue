...
<!--                 v-on:transitionenter="transition ease-out duration-100"-->
<!--                 v-on:transitionstart="transform opacity-0 scale-95"-->
<!--                 v-on:transitionend="transform opacity-100 scale-100"-->
<!--                 v-on:transitionleave="transition ease-in duration-75"-->
<!--                 v-on:transitionstart="transform opacity-100 scale-100"-->
<!--                 v-on:transitionend="transform opacity-0 scale-95"-->
<!--              class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg md:w-48">-->
